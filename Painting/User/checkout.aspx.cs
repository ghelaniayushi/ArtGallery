    ...
    public partial class checkout : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            if (Button4.Text == "PROCEED TO CHECKOUT")
            {
                ...
                cs.insertCheck_tbl(txtfnm.Text, txtlnm.Text, txtemail.Text, txtphno.Text, drpct.SelectedValue, drpstate.SelectedValue, txtadd1.Text, txtadd2.Text, txtpin.Text, drpcom.SelectedValue, p1, p2, p3);
            }
