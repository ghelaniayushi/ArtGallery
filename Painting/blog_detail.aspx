<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="blog_detail.aspx.cs" Inherits="Painting.blod_detail" %>
                ...
                <div class="col-md-3">
                    <div class="blog_1l">
                        ...
                        <div class="blog_1l1 bg_border p-3 mt-4">
                            ...
                            <h6 class="font_14"><a href="blog_detail.html"><i class="fa fa-circle-o me-1 col_pink font_8"></i>Realism <span class="pull-right">(03)</span></a></h6>
                            <hr>
                            <h6 class="font_14"><a href="blog_detail.html"><i class="fa fa-circle-o me-1 col_pink font_8"></i>Magazine <span class="pull-right">(15)</span></a></h6>
                            <hr>
                            <h6 class="font_14"><a href="blog_detail.html"><i class="fa fa-circle-o me-1 col_pink font_8"></i>News <span class="pull-right">(10)</span></a></h6>
                            <hr>
                            <h6 class="font_14"><a href="blog_detail.html"><i class="fa fa-circle-o me-1 col_pink font_8"></i>Photoshop <span class="pull-right">(08)</span></a></h6>
                            <hr>
                        ...
                        <div class="blog_1dt2 row mt-4">
                            <div class="col-md-2">
                                <div class="blog_1dt2l text-center">
                                    <h4>19
                                        <br>
                                        <hr class="line m-auto mt-2 mb-2">
                                        MAY
                                        <hr class="line m-auto mt-2">
                                    </h4>
                                </div>
                            </div>
                            <div class="col-md-10">
