<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin_Register.aspx.cs" Inherits="Painting.Admin_Register" %>
    ...
    <div style="background-color: #2E2B2D; min-height: 100vh; display: flex; justify-content: center; align-items: center; margin-top: 120px; padding: 50px;">
        <div style="display: flex; background: #2D2A2C; padding: 30px; border-radius: 12px; box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.1); width: 850px; align-items: center;">
            ...
            <div style="flex: 1; padding: 20px;">
                <h2 style="text-align: center; margin-bottom: 20px; color: #C22752;">Admin Registration</h2>

                <div style="margin-bottom: 15px;">
                    <asp:TextBox ID="txtFullName" runat="server" placeholder="Full Name"
                        Style="width: 100%; padding: 12px; border: none; border-radius: 8px; background: #575456; color: white; outline: none;">
                    </asp:TextBox>
                </div>
                ...
                <asp:Button ID="btnRegisterAdmin" runat="server" Text="Register as Admin" OnClick="btnRegisterAdmin_Click"
